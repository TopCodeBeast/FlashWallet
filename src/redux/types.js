...
//swap actions
export const SET_CURRENT_SWAP_TXN = 'SET_CURRENT_SWAP_TXN';
export const SET_CURRENT_SWAP_ERROR = 'SET_CURRENT_SWAP_ERROR';
export const SET_CURRENT_SWAP_STATUS = 'SET_CURRENT_SWAP_STATUS';
